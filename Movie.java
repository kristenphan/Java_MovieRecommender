...
/**
 * An immutable passive data object (PDO) to the data about one movie 
 * e.g. IMDB id, title, year, genres, etc. 
 */
public class Movie {
    private String id;
    ...
    // Return the country in which the movie was made
    public String getCountry(){
        return country;
    }

    // Return the name of the movie director(s)
